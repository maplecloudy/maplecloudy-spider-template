 ...
 * Date  2020-11-04
 */
public class HEnanzhaobiaocaigouwangTermplate extends AbstractTemplate {
    
  public HEnanzhaobiaocaigouwangTermplate() throws MalformedURLException {
    // 模板名字，请以网址全程为准
    name = "河南招标采购网";
    // 爬虫种子页面
    addSeedLink("http://www.hnzbcg.com.cn/", "首页");
    // 爬虫更新的需要的链接
    addUpdateLink("http://www.hnzbcg.com.cn/zbinfo/node_16.shtml", "列表第一页");
    addUpdateLink("http://www.hnzbcg.com.cn/zbinfo/node_16_2.shtml", "列表第二页");
    // 网站所有有的链接类型，以及对应的正则
    addDict("首页", "http://www.hnzbcg.com.cn/", "GET", "utf-8");
    addDict("列表第一页", "http://www.hnzbcg.com.cn/zbinfo/node_\\d+.shtml", "GET", "utf-8");
    addDict("列表页", "http://www.hnzbcg.com.cn/zbinfo/node_\\d+_\\d+.shtml", "GET", "utf-8");
    addDict("详情页", "http://www.hnzbcg.com.cn/\\w+/\\d+-\\d+/\\d+/\\d+.shtml", "GET", "utf-8");
  ...
  public void genLIEbiaodiyiyeLinks(List<Outlink> outlinks, Outlink url, Content content, RunMode runMode) throws UnsupportedEncodingException, MalformedURLException {
    ...
    Elements elements = doc.select("div.zbox").select("ul>li");
    ...
    Elements select = doc.select("div.pagedown");
    System.out.println(select.html());
    System.out.println(select.html().split("pageNumTotal =")[1]);
    int pageNo = Integer.valueOf(select.html().split("pageNumTotal =")[1].split(";")[0].trim());
    for (int i = 2; i <= pageNo; i++) {
      Outlink outlink = new Outlink(url.getUrl().replace(".shtml", "_" + i + ".shtml"),"");
      outlinks.add(outlink);
    }
  }
...
//    System.out.println(contentHtml);
    ...
    //标题
    dataMap.put("title", doc.select(".cwzzw>h1").get(0).text());
    //副标题
...
//    String budget = "预算金额[\\s*|:|：]+([￥|¥][0-9|\\.*]+\\s*[\u4E00-\u9FA5]*)";
  ...
  public static void main(String[] args) throws Exception {
    String url;
    url = "http://www.hnzbcg.com.cn/";
    url = "http://www.hnzbcg.com.cn/zbinfo/node_16.shtml";
    url = "http://www.hnzbcg.com.cn/zbinfo/node_16_2.shtml";
    url = "http://www.hnzbcg.com.cn/zbinfo/2020-08/31/15213.shtml";
    ...
    HEnanzhaobiaocaigouwangTermplate parse = new HEnanzhaobiaocaigouwangTermplate();
