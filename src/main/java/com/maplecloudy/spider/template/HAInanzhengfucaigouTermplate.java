 ...
 * Date  2020-11-02
 */
public class HAInanzhengfucaigouTermplate extends AbstractTemplate {

  public HAInanzhengfucaigouTermplate() throws MalformedURLException {
    // 模板名字，请以网址全程为准
    name = "海南政府采购";
    // 爬虫种子页面
    addSeedLink("https://www.ccgp-hainan.gov.cn/zhuzhan/", "首页");
    // 爬虫更新的需要的链接
    addUpdateLink("https://www.ccgp-hainan.gov.cn/cgw/cgw_list.jsp?currentPage=1&begindate=&enddate=&title=&bid_type=&proj_number=&zone=&ctype=", "列表第一页");
    addUpdateLink("https://www.ccgp-hainan.gov.cn/cgw/cgw_list.jsp?currentPage=2&begindate=&enddate=&title=&bid_type=&proj_number=&zone=&ctype=", "列表第二页");
    // 网站所有有的链接类型，以及对应的正则
    addDict("首页", "https://www.ccgp-hainan.gov.cn/zhuzhan/", "GET", "utf-8");
    addDict("列表第一页", "https://www.ccgp-hainan.gov.cn/cgw/cgw_list.jsp\\?currentPage=1&begindate=&enddate=&title=&bid_type=&proj_number=&zone=&ctype=", "GET", "utf-8");
    addDict("列表页", "https://www.ccgp-hainan.gov.cn/cgw/cgw_list.jsp\\?currentPage=\\d+&begindate=&enddate=&title=&bid_type=&proj_number=&zone=&ctype=", "GET", "utf-8");
    addDict("详情页", "https://www.ccgp-hainan.gov.cn/cgw/\\w+.jsp\\?id=\\d+", "GET", "utf-8");
  ...
  public void genSHOUyeLinks(List<Outlink> outlinks, Outlink url, Content content, RunMode runMode) throws MalformedURLException {
    ...
    Outlink outlink = new Outlink("https://www.ccgp-hainan.gov.cn/cgw/cgw_list.jsp?currentPage=1&begindate=&enddate=&title=&bid_type=&proj_number=&zone=&ctype=","");
  ...
  public void genLIEbiaodiyiyeLinks(List<Outlink> outlinks, Outlink url, Content content, RunMode runMode) throws UnsupportedEncodingException, MalformedURLException {
    ...
    Elements tables = doc.select("div.index07_07_02");
    Elements select = tables.select("ul").select("li");

    for (Element element : select) {
      Elements b = element.getElementsByTag("a");
      String href = b.attr("href");
      if (href != null && href.startsWith("/cgw/")) {
        Outlink outlink = new Outlink("https://www.ccgp-hainan.gov.cn" + href,"");
        outlinks.add(outlink);
      }
    }
    Elements pageInfo = doc.select("div.nei02_04_02").select("ul").select("li");
    int pageNo = 100;
    for (Element ele : pageInfo) {
      String text = ele.text();
      if (text.contains("总共")) {
        pageNo = Integer.valueOf(text.split("总共")[1].split("页")[0]);
      }
    }

    for (int i = 2; i <= pageNo; i++) {
      Outlink outlink = new Outlink("https://www.ccgp-hainan.gov.cn/cgw/cgw_list.jsp?currentPage=" + i + "&begindate=&enddate=&title=&bid_type=&proj_number=&zone=&ctype=","");
      outlinks.add(outlink);
    }
  }
  ...
  public void genXIANGqingyeDatas(Map<String, String> dataMap, Outlink url, Content content, RunMode runMode) throws UnsupportedEncodingException, MalformedURLException {
    ...
    Elements contentElements = doc.select(".cg20-gl");
...
//    System.out.println(contentHtml);
    ...
    //标题
    dataMap.put("title", doc.select(".zx-xxxqy>h2").get(0).text());
    //副标题
...
//        }
    ...
    //信息来源
    dataMap.put("source", "海南省政府购买服务信息平台");
    //发布时间
...
//    String budget = "预算金额[\\s*|:|：]+([￥|¥][0-9|\\.*]+\\s*[\u4E00-\u9FA5]*)";
  ...
  public static void main(String[] args) throws Exception {
    String url;
    url = "https://www.ccgp-hainan.gov.cn/zhuzhan/";
    url = "https://www.ccgp-hainan.gov.cn/cgw/cgw_list.jsp?currentPage=1&begindate=&enddate=&title=&bid_type=&proj_number=&zone=&ctype=";
    url = "https://www.ccgp-hainan.gov.cn/cgw/cgw_list.jsp?currentPage=2&begindate=&enddate=&title=&bid_type=&proj_number=&zone=&ctype=";
//    url = "https://www.ccgp-hainan.gov.cn/cgw/cgw_show_zbgg.jsp?id=23589";
//    url = "https://www.ccgp-hainan.gov.cn/cgw/cgw_show_zbgg.jsp?id=24055";
//    url = "https://www.ccgp-hainan.gov.cn/cgw/cgw_show_jzxcsgg.jsp?id=7675";
    ...
    HAInanzhengfucaigouTermplate parse = new HAInanzhengfucaigouTermplate();
