 ...
 * Date  2020-11-07
 */
public class JIAshanzhaobiaocaigouwangTermplate extends AbstractTemplate {

  public JIAshanzhaobiaocaigouwangTermplate() throws MalformedURLException {
    // 模板名字，请以网址全程为准
    name = "嘉善招标采购网";
    // 爬虫种子页面
    addSeedLink("http://js.jxzbtb.cn/", "首页");
    // 爬虫更新的需要的链接
    addUpdateLink("http://js.jxzbtb.cn/jygg/003009/1.html", "列表第一页");
    addUpdateLink("http://js.jxzbtb.cn/jygg/003009/2.html", "列表第二页");
    // 网站所有有的链接类型，以及对应的正则
    addDict("首页", "http://js.jxzbtb.cn/", "GET", "utf-8");
    addDict("列表第一页", "http://js.jxzbtb.cn/jygg/\\d+/1.html", "GET", "utf-8");
    addDict("列表页", "http://js.jxzbtb.cn/jygg/\\d+/\\d+.html", "GET", "utf-8");
//    addDict("详情页", "http://js.jxzbtb.cn/jygg/\\d+/\\d+/\\d+/[0-9a-zA-Z_-]+.html/", "GET", "utf-8");
    addDict("详情页", "http://js.jxzbtb.cn/\\w+/\\d+/\\d+/\\d+/\\w+-\\w+-\\w+-\\w+-\\w+.html", "GET", "utf-8");
  ...
  public void genSHOUyeLinks(List<Outlink> outlinks, Outlink url, Content content, RunMode runMode) throws MalformedURLException {
    ...
    String[] urls = new String[]{
        "http://js.jxzbtb.cn/jygg/003002/1.html",
        "http://js.jxzbtb.cn/jygg/003009/1.html"};
  ...
  public void genLIEbiaodiyiyeLinks(List<Outlink> outlinks, Outlink url, Content content, RunMode runMode) throws UnsupportedEncodingException, MalformedURLException {
    ...
    Elements select = doc.select("a[href]").select("a[title]").select("a[target]");
    for (Element element : select) {
      String href = element.attr("href").trim();
      if (href.matches(".+\\.html")) {
        String newUrl = "http://js.jxzbtb.cn/" + href;
        Outlink outlink = new Outlink(newUrl, "");
        outlinks.add(outlink);
      }
    }
    int pageNo = 75;
    if (url.getUrl().contains("003002")) {
      pageNo = 660;
    }
    for (int i = 2; i <= pageNo; i++) {
      Outlink outlink = new Outlink(url.getUrl().replace("1.html", i + ".html"), "");
      outlinks.add(outlink);
    }
  }
  ...
  public void genXIANGqingyeDatas(Map<String, String> dataMap, Outlink url, Content content, RunMode runMode) throws UnsupportedEncodingException, MalformedURLException {
    ...
    Elements contentElements = doc.select(".ewb-container.clearfixn");
...
//    System.out.println(contentHtml);
    ...
    //标题
    dataMap.put("title", doc.select(".infoContentTitle").get(0).text());
    //副标题
...
//    String budget = "预算金额[\\s*|:|：]+([￥|¥][0-9|\\.*]+\\s*[\u4E00-\u9FA5]*)";
  ...
  public static void main(String[] args) throws Exception {
    String url;
    url = "http://js.jxzbtb.cn/";
    url = "http://js.jxzbtb.cn/jygg/003009/1.html";
    url = "http://js.jxzbtb.cn/jygg/003009/66.html";
    url = "http://js.jxzbtb.cn/jygg/003002/003002001/20191126/f85e1168-5f78-4ee2-a101-24f90ebb6e64.html";
    ...
    JIAshanzhaobiaocaigouwangTermplate parse = new JIAshanzhaobiaocaigouwangTermplate();
