 ...
 * Date  2020-11-06
 */
public class SHENlianzhaobiaocaigouwangTermplate extends AbstractTemplate {

  public SHENlianzhaobiaocaigouwangTermplate() throws MalformedURLException {
    // 模板名字，请以网址全程为准
    name = "深联招标采购网";
    // 爬虫种子页面
    addSeedLink("http://www.sztc.com/", "首页");
    // 爬虫更新的需要的链接
    addUpdateLink("http://www.sztc.com/bulletin/index.htm", "列表第一页");
    addUpdateLink("http://www.sztc.com/bulletin/index_2.htm", "列表第二页");
    // 网站所有有的链接类型，以及对应的正则
    addDict("首页", "http://www.sztc.com/", "GET", "utf-8");
    addDict("列表第一页", "http://www.sztc.com/bulletin/index.htm", "GET", "utf-8");
    addDict("列表页", "http://www.sztc.com/bulletin/index_\\d.htm", "GET", "utf-8");
    addDict("详情页", "http://www.sztc.com/\\w+/\\d+.htm", "GET", "utf-8");
  ...
  public void genSHOUyeLinks(List<Outlink> outlinks, Outlink url, Content content, RunMode runMode) throws MalformedURLException {
    if (!(runMode == RunMode.BOTH || runMode == RunMode.FETCH))
      return;
    Outlink outlink = new Outlink("http://www.sztc.com/bulletin/index.htm", "");
  ...
  public void genLIEbiaodiyiyeLinks(List<Outlink> outlinks, Outlink url, Content content, RunMode runMode) throws UnsupportedEncodingException, MalformedURLException {
    ...
    Elements select1 = document.select(".lb-link>ul>li>a");
    ...
    Elements select = document.select(".pag-txt>em");
    int flag = 0;
    for (Element element : select) {
      ...
      if (flag == 3) {
        ...
        for (int i = 1; i <= page; i++) {
          Outlink outlink = new Outlink("http://www.sztc.com/bulletin/index_" + i + ".htm", "");
          outlinks.add(outlink);
        }
      }
    }
...
//    System.out.println(contentHtml);
    ...
    //标题
    dataMap.put("title", doc.select("#bulletinTitle").get(0).text());
    //副标题
...
//    String budget = "预算金额[\\s*|:|：]+([￥|¥][0-9|\\.*]+\\s*[\u4E00-\u9FA5]*)";
  ...
  public static void main(String[] args) throws Exception {
    String url;
    url = "http://www.sztc.com/";
    url = "http://www.sztc.com/bulletin/index.htm";
        url = "http://www.sztc.com/bulletin/index_2.htm";
        url = "http://www.sztc.com/bidBulletin/61931.htm";
    ...
    SHENlianzhaobiaocaigouwangTermplate parse = new SHENlianzhaobiaocaigouwangTermplate();
